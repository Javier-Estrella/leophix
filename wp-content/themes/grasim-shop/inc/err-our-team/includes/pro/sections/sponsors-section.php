<?php
if ( ! function_exists( 'IFT_our_sponsors_activate' ) ) {
	function IFT_our_sponsors_activate(){	
		?>
			...
			<div class="our_sponsors_info scroll-element js-scroll fade-in-bottom">
				...
				<div class="our_sponsors_contain">
					<div id="our_sponsors_demo" class="owl-carousel owl-theme our_sponsors_demo">
						<?php
						$our_sponsors_section_content  = get_theme_mod( 'our_sponsors_section_content',inpersttion_theme_get_sponsors_default());
