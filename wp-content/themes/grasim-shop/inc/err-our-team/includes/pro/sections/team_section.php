<?php
if ( ! function_exists( 'IFT_our_team_activate' ) ) :
	function IFT_our_team_activate(){
		?>
		<div class="our_team_section">
			<div class="our_team_info scroll-element js-scroll fade-in-bottom">
				...
				<div class="our_team_data">
					<?php 
					$our_team_section_content  = get_theme_mod( 'our_team_section_content',inpersttion_theme_get_team_default());
