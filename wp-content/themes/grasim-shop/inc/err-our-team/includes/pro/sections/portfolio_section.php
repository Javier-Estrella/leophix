<?php
if ( ! function_exists( 'IFT_our_portfolio_section_activate' ) ) {
	function IFT_our_portfolio_section_activate(){
		?>
			<div class="our_portfolio_info" id="our_portfolio_info">
				<div class="our_portfolio_data scroll-element js-scroll fade-in-bottom">
					...
					<div class="wrappers our_portfolio_section">
						<?php 
						$our_portfolio_section_content  = get_theme_mod( 'our_portfolio_section_content',inpersttion_theme_get_portfolio_default());
