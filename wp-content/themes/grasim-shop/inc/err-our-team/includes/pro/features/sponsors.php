		...
		//Our Sponsors in Title
			...
			$wp_customize->add_control( new WP_Customize_Control(
		    	...
		    	array(
					...
					'active_callback' => 'IFT_our_sponsors_general_callback',     
				)
			) );
		...
		//Our sponsors in Text color
	        ...
	        $wp_customize->add_control( new Customize_Transparent_Color_Control( 
		        ...
		        array(
		            ...
		            'priority'   => 10,
		            'section'    => 'our_sponsors_section',   
		            'active_callback' => 'IFT_our_sponsors_design_callback',
		        ) 
	        ) ); 
...
function IFT_our_sponsors_general_callback(){
...
function IFT_our_sponsors_design_callback(){
