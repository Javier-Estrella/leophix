	    ...
	    //Our Portfolio in Title
			...
			$wp_customize->add_control( new WP_Customize_Control(
		    	...
		    	array(
					...
					'active_callback' => 'IFT_our_portfolio_general_callback',
				)
			) );
		...
		//Our Portfolio in Background Title
		    ...
		    $wp_customize->add_control( new Custom_GeneratePress_Upsell_Section(
		    	...
		    	array(
			        ...
			        'active_callback' => 'IFT_our_portfolio_design_callback',
		        )
		    )); 
...
function IFT_our_portfolio_general_callback(){
...
function IFT_our_portfolio_design_callback(){
