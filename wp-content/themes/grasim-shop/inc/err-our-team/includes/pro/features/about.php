	...
	//About Section	
		    ...
		    //Layout1 title
			    ...
			    $wp_customize->add_control( new WP_Customize_Control(
			    	...
			    	array(
				        ...
				        'section' => 'about_section',
				        'type'  => 'text',
				        'active_callback' => 'IFT_about_layout1_callback',
			        )
			    ));
			//Layout1 subheading
		...
		//Layout2
			...
			$wp_customize, 'about_section_content', array(
	            ...
	            'active_callback' => 'IFT_about_layout2_callback',
			    ) ) );
...
function IFT_about_layout1_callback(){
...
function IFT_about_layout2_callback(){
	$about_section_layouts = get_theme_mod( 'about_section_layouts','layout2');
