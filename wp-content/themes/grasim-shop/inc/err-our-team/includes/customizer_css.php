...
function custom_customize_css(){
	...
	<style type="text/css">
		a.social_icon i{
			/*background-color: <?php echo esc_attr(get_theme_mod('social_icon_bg_color','#fff')); ?>;
			color: <?php echo esc_attr(get_theme_mod('social_icon_color','#425E79')); ?>;
			border-color: <?php echo esc_attr(get_theme_mod('social_icon_bg_color','#fff')); ?>;*/
			background-color: <?php echo esc_attr(get_theme_mod('social_icon_bg_color',$default_setting['social_icon_bg_color'])); ?>;
			color: <?php echo esc_attr(get_theme_mod('social_icon_color',$default_setting['social_icon_color'])); ?>;
			border-color: <?php echo esc_attr(get_theme_mod('social_icon_bg_color',$default_setting['social_icon_bg_color'])); ?>;
		}
		a.social_icon i:hover{
			/*background-color: <?php echo esc_attr(get_theme_mod('social_icon_bg_hover_color','#425e79')); ?>;
			color: <?php echo esc_attr(get_theme_mod('social_icon_hover_color','#fff')); ?>;
			border-color: <?php echo esc_attr(get_theme_mod('social_icon_bg_hover_color','#425e79')); ?>;*/
			background-color: <?php echo esc_attr(get_theme_mod('social_icon_bg_hover_color',$default_setting['social_icon_bg_hover_color'])); ?>;
			color: <?php echo esc_attr(get_theme_mod('social_icon_hover_color',$default_setting['social_icon_hover_color'])); ?>;
			border-color: <?php echo esc_attr(get_theme_mod('social_icon_bg_hover_color',$default_setting['social_icon_bg_hover_color'])); ?>;
		}
	/*--------------------------------------------------------------
	...
	--------------------------------------------------------------*/
		.featured-section_data{
			color: <?php echo esc_attr(get_theme_mod('featured_section_main_text_color',$default_setting['featured_section_main_text_color'])); ?>;	
		}
