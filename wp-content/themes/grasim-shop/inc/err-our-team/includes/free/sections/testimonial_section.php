<?php
if ( ! function_exists( 'IFT_our_testimonial_activate' ) ) :
	function IFT_our_testimonial_activate(){
		?>
		<div class="our_testimonial_section">
			<div class="our_testimonial_info scroll-element js-scroll fade-in-bottom">
				...
				<div class="owl-carousel owl-theme testinomial_owl_slider" id="testinomial_owl_slider">
					<?php
					$our_testimonial_section_content  = get_theme_mod( 'our_testimonial_section_content',inpersttion_theme_get_testimonial_default());
