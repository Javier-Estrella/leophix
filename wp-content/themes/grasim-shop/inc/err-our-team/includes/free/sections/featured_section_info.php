<?php
if ( ! function_exists( 'IFT_featured_section_info_activate' ) ) :
	function IFT_featured_section_info_activate(){

		$featured_section_content  = get_theme_mod( 'featured_section_content',inpersttion_theme_get_info_default());
							...
							<div class="section-featured-wrep">
								<div class="featured-thumbnail"> 
									...
									<div class="featured-description">
										<p><?php echo esc_attr($info_item->text); ?></p>
									</div>
								</div>
							</div>
							<?php
