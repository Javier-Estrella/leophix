<?php
/*Featured Slider*/
if ( ! function_exists( 'IFT_featured_slider_activate' ) ) {
	function IFT_featured_slider_activate(){
		$featuredimage_slider  = get_theme_mod( 'featuredimage_slider',inpersttion_theme_get_slider_default());
