		  		...
		  		<div class="innermenubox">	      			
		  			<?php if(has_nav_menu('primary-menu')){ ?>
			          	<div class="toggle-nav mobile-menu">
		        			<button onclick="construction_hub_open_nav()" class="responsivetoggle"><i class="fas fa-bars"></i><span class="screen-reader-text"><?php esc_html_e('Open Button','roofing-contractor'); ?></span></button>
		      			</div>
		      		<?php }?>
		 	 		<div id="mySidenav" class="nav sidenav">
		    			<nav id="site-navigation" class="main-navigation" role="navigation" aria-label="<?php esc_attr_e( 'Top Menu', 'roofing-contractor' ); ?>">
			              	<?php if(has_nav_menu('primary-menu')){
			                  	wp_nav_menu( array( 
		      				...
		      				<a href="javascript:void(0)" class="closebtn mobile-menu" onclick="construction_hub_close_nav()"><i class="fas fa-times"></i><span class="screen-reader-text"><?php esc_html_e('Close Button','roofing-contractor'); ?></span></a>
		        		</nav>
		      		</div>
